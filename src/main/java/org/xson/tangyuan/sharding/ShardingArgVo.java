...
public class ShardingArgVo {
	...
	// public ShardingArgVo(String table, ShardingTemplate template, String[] keywords, ShardingDefVo shardingDef) {
	// this.table = table;
	...
	// public ShardingResult getShardingResult(Map<String, Object> arg) {
