...
import org.xson.tangyuan.transaction.MultipleTransactionManager;
...
public class SqlServiceContext implements IServiceContext {
	...
	protected SqlServiceContext() {
		...
		this.transactionManager = new MultipleTransactionManager(TangYuanContainer.getInstance().getDataSourceManager());
