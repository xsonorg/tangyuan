 ...
 * 上下文监控信息
 */
public class SqlServiceContextInfo {
	...
	public SqlServiceContextInfo(int hashCode) {
	...
	public String toString() {
		...
		if (execTime < TangYuanContainer.getInstance().monitorIntervalTime) {
			return null;
		}
	...
	public void joinMonitor() {
		TangYuanContainer.getInstance().getMonitorThread().add(this);
	}
